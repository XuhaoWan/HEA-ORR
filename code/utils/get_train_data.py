...
sites_types = np.zeros(shape = (360, 1))
dataset = np.zeros(shape = (360, 15, 6))
for j in range(90):
    ...
    sites_types[j] = str(symbols[0])+str(symbols[1])
...
np.save('sitestype.npy', sites_types)
